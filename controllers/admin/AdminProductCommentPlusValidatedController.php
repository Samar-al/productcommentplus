<?php
/**
 * AdminProductCommentPlusValidatedController.php
 *
 * Controller for managing validated product comments
 *
...
class AdminProductCommentPlusValidatedController extends ModuleAdminController
{
    public function __construct()
    {
        $this->table = ProductCommentPlusValidatedClass::$definition['table'];
        $this->className = ProductCommentPlusValidatedClass::class;
        $this->module = Module::getInstanceByName('productcommentplus');
        $this->identifier = ProductCommentPlusValidatedClass::$definition['primary'];
        $this->_orderBy = ProductCommentPlusValidatedClass::$definition['primary'];
        $this->bootstrap = true;
